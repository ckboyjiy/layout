    ...
    <div className={`app ${isPrintPreview ? 'print-preview' : ''}`}>
      ...
      <main className="content">
        <section className={`content-box ${showSection2 ? 'hidden' : ''}`}>
          ...
          <img src="https://picsum.photos/800/400?random=1" alt="Article" className="article-image" />
          ...
          <img src="https://picsum.photos/800/400?random=2" alt="Technology" className="article-image" />
          ...
          {showSection2 && <section className={`content-box`}>
              ...
              <img src="https://picsum.photos/800/400?random=3" alt="Future" className="article-image" />
              ...
              <img src="https://picsum.photos/800/400?random=4" alt="Society" className="article-image" />
